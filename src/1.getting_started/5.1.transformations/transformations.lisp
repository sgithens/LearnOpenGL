...
(defun transformations (&key (vertex-shader-file "src/1.getting_started/5.1.transformations/5.1.transform.vs")
              ...
              (let* ((time (%cl-glfw3:get-time))
                     (transform (3d-matrices:marr4
                                  (3d-matrices:nmrotate
                                    (3d-matrices:mtranslation (3d-vectors:vec 0.5 -0.5 0))
                                    3d-vectors:+vz+ time))))
                (use our-shader)
