...
(defun coordinate-systems-depth (&key (vertex-shader-file "src/1.getting_started/6.2.coordinate_systems_depth/6.2.coordinate_systems.vs")
                                      (fragment-shader-file "src/1.getting_started/6.2.coordinate_systems_depth/6.2.coordinate_systems.fs")
      ...
      (loop until (cl-glfw3:window-should-close-p)
          do (progn
              ...
              (let ((time (%cl-glfw3:get-time))
                ...
                (3d-matrices:nmrotate model (3d-vectors:vec3 0.5 1.0 0.0) time)
