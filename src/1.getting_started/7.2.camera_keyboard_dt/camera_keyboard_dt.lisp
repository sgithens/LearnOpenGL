...
(defun camera-keyboard-dt (&key (vertex-shader-file "src/1.getting_started/7.2.camera_keyboard_dt/7.2.camera.vs")
                                (fragment-shader-file "src/1.getting_started/7.2.camera_keyboard_dt/7.2.camera.fs")
