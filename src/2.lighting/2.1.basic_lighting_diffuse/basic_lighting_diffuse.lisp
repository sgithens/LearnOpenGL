...
(defun basic-lighting-diffuse (&key (lighting-vertex-shader-file  "src/2.lighting/2.1.basic_lighting_diffuse/2.1.basic_lighting.vs")
                              (lighting-fragment-shader-file      "src/2.lighting/2.1.basic_lighting_diffuse/2.1.basic_lighting.fs")
                              (light-cube-vertex-shader-file      "src/2.lighting/2.1.basic_lighting_diffuse/2.1.light_cube.vs")
                              (light-cube-fragment-shader-file    "src/2.lighting/2.1.basic_lighting_diffuse/2.1.light_cube.fs")
                              (vertices #(
                                 ; positions    ; normals
    ...
    (let* ((lighting-shader (make-shader lighting-vertex-shader-file
      ...
      (loop until (cl-glfw3:window-should-close-p)
          do (progn
              ...
              (set-vec3 lighting-shader "lightPos" #(1.2 1.0 2.0))
