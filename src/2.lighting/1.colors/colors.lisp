...
(defun colors       (&key (lighting-vertex-shader-file     "src/2.lighting/1.colors/1.colors.vs")
                          (lighting-fragment-shader-file   "src/2.lighting/1.colors/1.colors.fs")
                          (light-cube-vertex-shader-file   "src/2.lighting/1.colors/1.light_cube.vs")
                          (light-cube-fragment-shader-file "src/2.lighting/1.colors/1.light_cube.fs")
